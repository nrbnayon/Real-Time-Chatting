(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_dd2444._.js", {
...
"[project]/app/(auth)/otp-verify/page.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function VerifyOTP() {
    ...
    const { verifyOtp, resendOtp } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useAuth$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
        ...
        "VerifyOTP.useEffect": ()=>{
            ...
            if (expireTime) {
                ...
                if (remainingTime > 0) {
                    ...
                    }["VerifyOTP.useEffect.timer"], 1000);
                    return ({
                        "VerifyOTP.useEffect": ()=>clearInterval(timer)
                    })["VerifyOTP.useEffect"];
                } else {
                    setIsResendDisabled(false);
                }
    ...
    const handleSubmit = async (e)=>{
        e.preventDefault();
        if (!email || !otp) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Please enter the OTP to verify your account.");
            return;
        }
        setIsLoading(true);
        try {
            ...
            if (result?.success) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Your account has been successfully verified!");
                sessionStorage.removeItem("registrationEmail");
                sessionStorage.removeItem("registrationEmailExpireTime");
                router.push("/login");
            } else {
                const errorMessage = result?.message || "Wrong OTP. Please check and try again.";
            ...
            const errorMessage = error?.response?.data?.message || error?.message || "An unexpected error occurred while verifying your account.";
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(errorMessage);
        } finally{
            setIsLoading(false);
        }
    ...
    const handleResendOTP = async ()=>{
        if (!email) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Email is required to resend OTP.");
            return;
        }
        try {
            setIsLoading(true);
            ...
            if (result?.success) {
                ...
                sessionStorage.setItem("registrationEmailExpireTime", newExpireTime.toString());
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(result.message || "A new OTP has been sent to your email.");
                setIsResendDisabled(true);
                setTimeRemaining(180);
                window.location.reload();
            } else {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(result?.message || "Failed to resend OTP");
            }
        } catch (error) {
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardHeader"], {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$shield$2d$check$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__ShieldCheck$3e$__["ShieldCheck"], {
                            ...
                            fileName: "[project]/app/(auth)/otp-verify/page.js",
                            lineNumber: 135,
                            columnNumber: 11
                        }, this),
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: isResendDisabled && timeRemaining > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "w-full p-2 bg-yellow-100 text-yellow-800 rounded",
                                    children: [
                                        "OTP Expires in ",
                                        timeRemaining,
                                        " seconds"
...
_s(VerifyOTP, "lz5WrVvTRPEESrdHQ0BZzwZX3sY=", false, function() {
    return [
...
_c = VerifyOTP;
var _c;
__turbopack_refresh__.register(_c, "VerifyOTP");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_refresh__.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
"[project]/app/(auth)/otp-verify/page.js [app-rsc] (ecmascript, Next.js server component, client modules)": ((__turbopack_context__) => {
...
//# sourceMappingURL=_dd2444._.js.map