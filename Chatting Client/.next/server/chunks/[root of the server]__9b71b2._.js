...
"[project]/lib/cookies.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$cookies$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/lib/cookies.js [app-route] (ecmascript)");
...
async function POST(request) {
    ...
    try {
        ...
        const clientResponse = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
            data,
        ...
        if (token) {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$cookies$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["setCookie"])(clientResponse, "accessToken", token);
        } else {
            console.warn("Access token not found in response");
        }
        if (userData) {
            console.log("Setting user data cookie");
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$cookies$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["setCookie"])(clientResponse, "user", JSON.stringify(userData));
        } else {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__9b71b2._.js.map